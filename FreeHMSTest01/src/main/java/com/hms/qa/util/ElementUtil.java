...
public class ElementUtil {
	...
	public void doNewSelect(By locator, String value) {
		try {
...
public void doActionsNewSelect(By locator, String... value) {
		try {
			Actions action = new Actions(driver);
		action.selectByVisibleText(new Select(getElement(locator)), value).build().perform();
		} catch (Exception e) {
			System.out.println("some exception got occurred while passing the values to the webelement : " + locator);
			System.out.println(e.getMessage());
		}
